const chroniclesOfEmoryTate2011 = [
    ...
    // },
    {
        quote: '"Without a baseline for truth, we (humans) are like savage apes, doing dirt in the dark, and smiling by day. <span class="red-text">Animals.</span> Still, no one is perfect."',
        display: true,
        date: `Dec 12, 2011`,
        image: null
    },
    ...
    // },
    {
        quote: '"Inaction is, of itself, <span class="red-text">an action.</span> Sun Xu. <span class="red-text">Idiots run the world and they are cowards too.</span>"',
        display: true,
        date: `Dec 13, 2011`,
    ...
    // },
    {
        quote: '"Whereas it seems impossible for one man to be smarter that all the rest put together, <span class="red-text">One man can be right while everyone else is wrong.</span>"',
        display: true,
        date: `Dec 15, 2011`,
    ...
    // },
    {
        quote: '"To achieve brilliance is a wonderful thing. <span class="red-text">To act brilliantly is rare.</span> Take action and where do you fit in on the brilliance scale?"',
        display: true,
        date: `Dec 26, 2011`,
        image: null
    },
    ...
    // },
    {
        quote: `"Confusing knowledge with wisdom is a dangerous trend. Life may seem like a game, but in fact is deadly serious. <span class="red-text">Wisdom breeds action.</span>"`,
        display: true,
        date: `Jan 16, 2012`,
        image: "/images/emory5.png"
    },
    ...
    // },
    {
        quote: `"The first human reaction to FEAR, is <span class="red-text">SILENCE.</span> Learned helplessness. Difficult to induce, Impossible to maintain."`,
        display: true,
        date: `Feb 7, 2012`,
        image: null
    },
    ...
    // },
    {
        quote: `"Being real means NOT being a reflection of pop culture. <span class="red-text">How can you be an individual when your very thoughts are cloned.</span> Be yourself."`,
        display: true,
        date: `Apr 19, 2012`,
        image: null
    },
